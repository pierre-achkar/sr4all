...
class BooleanQueryItem(BaseModel):
    ...
    """
    boolean_query_string: Optional[str] = Field(None, description="The exact boolean query string.")
    database_source: Optional[List[str]] = Field(None, description="The database this query was run on (e.g., PubMed).")
    verbatim_source: Optional[str] = Field(None, description="The text span supporting this query.")
...
class ReviewExtraction(BaseModel):
    ...
    year_range: Optional[Evidence[str]] = Field(
        None, description="The range of years covered by the search (e.g., '1990-2023')."
    )
