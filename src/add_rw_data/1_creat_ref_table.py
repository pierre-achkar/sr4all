...
Config = {
	"sys_rev_path": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/sys_rev_17/sr_with_dois.json",
	"seed_path": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/seed_collection/overall_doi.jsonl",
	"csmed_1_path": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/csmed/e2cs_with_dois.json",
	"csmed_2_path": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/csmed/pcs_with_dois.json",
	"autobool_path": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/autobool/autobool_with_dois.parquet",
	"clef_path": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/clef/tar_19_18_17.parquet",
	"output_parquet": "/home/fhg/pie65738/projects/sr4all/data/rw_ds/raw/refs_id_doi.parquet",
	"log_path": "/home/fhg/pie65738/projects/sr4all/logs/add_data/creat_ref_table.log",
}
...
def main() -> None:
	...
	for src in all_srcs:
		others = set().union(*(src_dois[s] for s in all_srcs if s != src)) if len(all_srcs) > 1 else set()
