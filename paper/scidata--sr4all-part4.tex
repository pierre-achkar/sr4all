...
The validation population comprises the 108,079 reviews processed by the extraction pipeline. Of these, 107,611 contain at least one non-empty extracted field in the final corpus. The unit of validation is the document: for each sampled review, all extracted methodological fields are assessed against the source PDF. Results are reported per field type.
...
\]
Applying the finite population correction for $N = 108{,}079$,
\[
n = \frac{n_0}{1 + \frac{n_0 - 1}{N}} \approx 384,
\]
